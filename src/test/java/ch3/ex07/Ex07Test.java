...
public class Ex07Test {
	...
	public void testNatural() {
		...
		Arrays.sort(words, Ex07.generateStringComparator(isReverse, isCaseInsensitive,
				unIncludeSpace));
		assertThat(words, is(new String[] { "0 1", "00", "03", "T2", "t0", "t3" }));
	}
	...
	public void testReverse() {
		...
		Arrays.sort(words, Ex07.generateStringComparator(isReverse, isCaseInsensitive,
				unIncludeSpace));
		assertThat(words, is(new String[] { "t3", "t0", "T2", "03", "00", "0 1" }));
	}
	...
	public void testUnIncludeSpace() {
		...
		Arrays.sort(words, Ex07.generateStringComparator(isReverse, isCaseInsensitive,
				unIncludeSpace));
		assertThat(words, is(new String[] { "00", "0 1", "03", "T2", "t0", "t3" }));
	}
	...
	public void testIgnoreCase() {
		...
		Arrays.sort(words, Ex07.generateStringComparator(isReverse, isCaseInsensitive,
				unIncludeSpace));
		assertThat(words, is(new String[] { "0 1", "00", "03", "t0", "T2", "t3" }));
	}

	@Test
	public void testReverseUnIncludeSpace() {
		isReverse = unIncludeSpace = true;
		Arrays.sort(words, Ex07.generateStringComparator(isReverse, isCaseInsensitive,
				unIncludeSpace));
		assertThat(words, is(new String[] { "t3", "t0", "T2", "03", "0 1", "00" }));
	}
	...
	public void testReverseIgnoreCase() {
		...
		Arrays.sort(words, Ex07.generateStringComparator(isReverse, isCaseInsensitive,
				unIncludeSpace));
		assertThat(words, is(new String[] { "t3", "T2", "t0", "03", "00", "0 1" }));
	}
	...
	public void testUnIncludeSapceIgnoreCase() {
		...
		Arrays.sort(words, Ex07.generateStringComparator(isReverse, isCaseInsensitive,
				unIncludeSpace));
		assertThat(words, is(new String[] { "00", "0 1", "03", "t0", "T2", "t3" }));
	}
	...
	public void testReverseIgnoreCaseUnIncludeSapce() {
		...
		Arrays.sort(words, Ex07.generateStringComparator(isReverse, isCaseInsensitive,
				unIncludeSpace));
		assertThat(words, is(new String[] { "t3", "T2", "t0", "03", "0 1", "00" }));
	}
}
